                        ...
                        <div class="col-xl-8 col-lg-5 col-md-7 mx-auto ">
                            <div class="card">
                                <div class="card-header text-start">
                                    <h4 class="font-weight-bolder align-items-center text-center">Ubah Buku</h4>
                                </div>
                                <div class="card-body">
                                    <?php
                                    include '../koneksi.php';
                                    $id = $_GET['id_buku'];
                                    $data = mysqli_query($koneksi, "select * from t_buku where id_buku ='$id'");
                                    while ($d = mysqli_fetch_array($data)) {
                                    ?>
                                        <form role="form" method="POST" action="act_edit_buku.php">
                                            <input type="text" hidden value="<?php echo $d['id_buku']; ?>" id="" name="id_buku">

                                            <div class="mb-3">
                                                <input type="text" value="<?= $d['nm_buku']; ?>" class="form-control form-control-lg" name="nm_buku" placeholder="Nama Peminjam" aria-label="peminjam">
                                            </div>
                                            <div class="mb-3 d-flex">
                                                <input type="text" class="form-control form-control-lg me-2" value="<?= $d['penulis']; ?>" name="penulis" placeholder="Penulis" aria-label="Nama Buku">
                                                <input type="text" class="form-control form-control-lg" value="<?= $d['penerbit']; ?>" name="penerbit" placeholder="Penerbit" aria-label="Nama Buku">
                                            </div>
                                            <div class="mb-3 d-flex">
